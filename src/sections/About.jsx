  ...
  return (
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        {/* Grid 1 - Photo (left side) */}
        <div className="grid-default-color flex items-center justify-center relative md:col-span-2">
  <img
    src="assets/my.PNG"
    alt="Profile"
    className="rounded-xl object-contain max-h-full max-w-full p-4 shadow-xl border border-gray-700"
  />
</div>

{/* Grid 2 - About Me card (right side) */}
<div className="flex items-end grid-default-color relative md:col-span-4 overflow-hidden">
  <img
...
// export default About; without distorting or changing anything add a column where i can add my photo keep tbe ui ux and aesthetic same 